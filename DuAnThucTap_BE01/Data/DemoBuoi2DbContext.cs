...
{
    public partial class DemoBuoi2DbContext : DbContext
    {
        public DemoBuoi2DbContext()
        {
        }

        public DemoBuoi2DbContext(DbContextOptions<DemoBuoi2DbContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<MvAssignmentusagestat> MvAssignmentusagestats { get; set; } = null!;
        public virtual DbSet<MvKioskassignmentstat> MvKioskassignmentstats { get; set; } = null!;
        public virtual DbSet<MvServiceassignmentstat> MvServiceassignmentstats { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=btonl2;Username=postgres;Password=123456");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MvAssignmentusagestat>(entity =>
            {
                entity.ToView("mv_assignmentusagestats");
            });

            modelBuilder.Entity<MvKioskassignmentstat>(entity =>
            {
                entity.ToView("mv_kioskassignmentstats");
            });

            modelBuilder.Entity<MvServiceassignmentstat>(entity =>
            {
                entity.ToView("mv_serviceassignmentstats");
            });
