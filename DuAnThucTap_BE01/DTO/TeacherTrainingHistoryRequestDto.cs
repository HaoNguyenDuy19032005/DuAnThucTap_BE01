...
{
    public class TeacherTrainingHistoryRequestDto
    {
        // Không cần Trainingid ở đây vì nó sẽ được sinh tự động hoặc được truyền qua URL cho các hành động Update/Delete
        ...
        public string Traininginstitutionname { get; set; } = string.Empty; // Khởi tạo để tránh null
